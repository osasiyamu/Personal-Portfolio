...
const ContactSection = ({ searchId }) => {
    ...
    const getContactInfo = () => {
        fetch(`http://localhost:5555/myportfolio/contact`)
		.then(response => {
			if (!response.ok) {
    ...
    const getWebsiteInfo = () => {
        fetch(`http://localhost:5555/myportfolio/website`)
		.then(response => {
			if (!response.ok) {
			  	throw new Error('Network response was not ok');
			}
    ...
    const searchUserContact = () => {
        fetch(`http://localhost:5555/userprofile/contact/${searchId}`)
		.then(response => {
			if (!response.ok) {
			  	throw new Error('Network response was not ok');
			}
    ...
    const searchUserWebsite = () => {
        fetch(`http://localhost:5555/userprofile/website/${searchId}`)
		.then(response => {
			if (!response.ok) {
			  	throw new Error('Network response was not ok');
			}
